...
const deleteJob= async() =>{
  try {
    const consfirm = window.confirm('Are you sure u want to ddelete');
    if(consfirm){
      ...
      <div class="grid grid-cols-1 md:grid-cols-70/30 w-full gap-6">
        <main>
          ...
          <div class="bg-white p-6 rounded-lg shadow-md mt-6">
            <h3 class="text-green-800 text-lg font-bold mb-6">{{ state.job.title }}</h3>
        ...
        <aside>
          ...
          <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <p class="my-2 bg-green-100 p-2 font-bold">{{ state.job.company.email }}</p>
